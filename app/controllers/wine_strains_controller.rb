class WineStrainsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @wine_strain.save
        format.html { redirect_to wine_strain_url(@wine_strain), notice: "Wine strain was successfully created." }
  ...
  def update
    respond_to do |format|
      if @wine_strain.update(wine_strain_params)
        format.html { redirect_to wine_strain_url(@wine_strain), notice: "Wine strain was successfully updated." }
